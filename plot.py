...
def diff_temperature_wafer():
    ...
    for seed in seeds:
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed2_AV_temperature_unknown_T2.0_known_T0.5.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T0.5_known_T0.5_modelB_T1.0.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T0.2_known_T0.2.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T1.0_known_T1.0.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T2.0_known_T2.0.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T0.5_known_T2.0.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T0.5_known_T0.5_modelB_T1.2.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed1_AV_temperature_unknown_T0.5_known_T0.5_modelB_T1.5.pkl", 'rb') as f:
            data = pickle.load(f)
    ...
    plt.fill_between(x, np.array(min_max_temperature_recall).mean(0) - np.array(min_max_temperature_recall).std(0),
                     ...
                     alpha=0.2)
    plt.legend(loc='best')
    plt.savefig("gifs/wafer_diff_temperature_"+model+"_init"+str(init)+"_known"+str(known)+"_recall.png")
    plt.show()
    ...
    plt.fill_between(x, np.array(min_max_temperature_precision).mean(0) - np.array(min_max_temperature_precision).std(0),
                     ...
                     alpha=0.2)
    plt.legend(loc='best')
    plt.savefig("gifs/wafer_diff_temperature_"+model+"_init"+str(init)+"_known"+str(known)+"_precision.png")
    plt.show()
...
def plot_performance_wafer():
    ...
    for seed in seeds:
        with open("log_AL/"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed"+str(seed)+"_random.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        f.close()
        with open("log_AL/"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed"+str(seed)+"_uncertainty.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        f.close()
        with open("log_AL/"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed"+str(seed)+"_AV_based.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        f.close()
        with open("log_AL/"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed"+str(seed)+"_AV_uncertainty.pkl", 'rb') as f:
            data = pickle.load(f)
        ...
        f.close()
        with open("log_AL/temperature_"+model+"_wafer_known"+str(known)+"_init"+str(init)+"_batch1500_seed"+str(seed)+"_AV_temperature_unknown_T0.5_known_T0.5_modelB_T1.0.pkl", 'rb') as f:
            data = pickle.load(f)
    ...
    plt.fill_between(x, np.array(temperature_precision).mean(0) - np.array(temperature_precision).std(0),
                     ...
                     alpha=0.2)
    plt.legend(loc='best')
    plt.savefig("gifs/wafer_"+model+"_init"+str(init)+"_known"+str(known)+"_precision.png")
    plt.show()
    ...
    plt.fill_between(x, np.array(temperature_acc).mean(0) - np.array(temperature_acc).std(0),
                     ...
                     alpha=0.2)
    plt.legend(loc='best')
    plt.savefig("gifs/wafer_"+model+"_init"+str(init)+"_known"+str(known)+"_accuracy.png")
    plt.show()
